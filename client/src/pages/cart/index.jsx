                    ...
                    ? cart.map((item, i) => {
                        return (
                          <tr key={i}>
                            ...
                            <td scope="row" className="text-center">
                              <span className={Style.tabDelete}>
                                <Link href={`/cart/${item.item._id}`}>
                                  <a> ✏ </a>
                                </Link>
                              </span>
                              <span
                                className={Style.tabDelete}
                                onClick={() =>
                                  handleDeleteOneItem(item.item._id)
                                }>
                                <AiFillDelete />
                              </span>
                            </td>
                ...
                <div className="row">
                  <div className="col-md-6 col-sm-11 col-xs-12 d-flex p-4 align-items-center justify-content-center">
                    {cart && cart.length > 0 ? (
                      <>
                        <button
                          className={
                            Style.checkoutBtn + " btn btn-dark ml-auto"
                          }
                  ...
                  <div className="col-md-6 col-sm-11 col-xs-12 d-flex p-4 align-items-center justify-content-center">
                    {cart.length > 0 && !checked ? (
                      <div
                        className={Style.checkoutBtn + " btn ml-auto"}
                        onClick={() => {
                          setTimeout(() => {
                            setChecked(true);
                          }, 1500);
                    ...
                    {checked ? (
                      <div className="d-flex flex-column justify-content-center">
                        <span className="p-2">
                          ⚠ feel safe 💝, we don&apos;t save
                          <br /> any information and don&apos;t share it 😊
                        </span>
                        <div
                          className="py-3"
                          style={{
