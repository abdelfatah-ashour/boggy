                ...
                <React.Fragment key={i}>
                  <div className="row">
                    <div className="col-sm-12 col-md-6">
                      <div className={Style.ContentImgItem}>
                        <img src={API + "/" + item.item.ImageProduct} alt="" />
                      </div>
                    </div>
                    <div className="col-sm-12 col-md-6">
                      <div className={Style.contentInfoItem}>
                        <ul>
                          <li>
                            <b>Name : </b>
                            {item.item.Name}
                          ...
                          <li>
                            <b>Total</b> : {item.item.Price * state.qty}
                          </li>
                        </ul>
                        <div className={Style.BtnEditQty}>
                          <b>QTY</b> :
                          <button
                            className="btn"
                            disabled={state.qty === 1 ? true : false}
                            onClick={() =>
                              dispatch({
                                type: "DEC",
                              })
