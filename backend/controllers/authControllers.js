...
const { validRegister, validLogin } = require("../utilities/validationInputs");
...
module.exports = {
  ...
  logout: async (req, res) => {
    ...
    return res.status(200).json({ success: true, message: "see you later ❤" });
  },
    ...
    if (!token) {
      ...
      if (!decoded) {
        return res.status(401).json({
          success: false,
          message: "invalid access resources please register or login",
        });
      }
      req.user = decoded;
